...
export default function App() {
  ...
  return (<div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 overflow-auto" dir="rtl">
    ...
    <header className="bg-white shadow-sm border-b sticky top-0 z-50 print:hidden">
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button onClick={() => setMenu(!menu)} className="xl:hidden p-2 hover:bg-gray-100 rounded-xl">{menu ? <X size={24}/> : <Menu size={24}/>}</button>
          <BaronLogo />
          <span className="text-xs text-gray-400 hidden sm:inline">v1.10.13</span>
        </div>
        <div className="flex items-center gap-3">
          <button 
    ...
    <div className="flex">
      <aside className="hidden xl:block w-56 bg-white border-l fixed top-[60px] bottom-0 overflow-y-auto print:hidden z-30">
      ...
      <main className="flex-1 p-4 xl:p-6 xl:mr-56 w-full overflow-x-auto">{content()}</main>
    </div>
